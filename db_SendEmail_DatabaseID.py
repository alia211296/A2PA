...
<p>
        Lot(s) is exists in database.<br>
        Go <a href="www.a2pa.intel.com"> A2PA Website </a> to view/download the data analysis result.<br>
</p>
<p style="color:grey;font-size:15px""><b>
       Database ID : {db_id}<br>
	   Validity : 1 month from the {datetime} <br>
</b></p>
...
msg['Subject'] = facr + " Success - View FACR analysis result through database ID."
